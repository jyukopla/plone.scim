...
# pylama:ignore=E501,C0301,W0613
...
def user_schema(context, request):
    ...
    return {
        ...
        "meta": {
            "resourceType": "Schema",
            "location": "{base_url:s}/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:User".format(
                base_url=base_url
            ),
        },
    }
...
def group_schema(context, request):
    ...
    return {
        ...
        "meta": {
            "resourceType": "Schema",
            "location": "{base_url:s}/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:Group".format(
                base_url=base_url
            ),
        },
    }
...
def service_provider_config_schema(context, request):
    ...
    return {
        ...
        "meta": {
            "resourceType": "Schema",
            "location": "{base_url:s}/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:ServiceProviderConfig".format(
                base_url=base_url
            ),
        },
    }
...
def resource_type_schema(context, request):
    ...
    return {
        ...
        "meta": {
            "resourceType": "Schema",
            "location": "{base_url:s}/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:ResourceType".format(
                base_url=base_url
            ),
        },
    }
...
def schema_schema(context, request):
    ...
    return {
        ...
        "meta": {
            "resourceType": "Schema",
            "location": "{base_url:s}/v2/Schemas/urn:ietf:params:scim:schemas:core:2.0:Schema".format(
                base_url=base_url
            ),
        },
    }
