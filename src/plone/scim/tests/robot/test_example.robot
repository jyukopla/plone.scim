...
#
#  $ bin/test -s plone.scim -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plone.scim.testing.PLONE_SCIM_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/scim/tests/robot/test_example.robot
#
