...
class ServiceProviderConfig(ScimView):
    """Render service provider configuration."""
            ...
            "authenticationSchemes": [
                {
                    ...
                    "documentationUri": "https://plonerestapi.readthedocs.io/en"
                    "/latest/authentication.html#json-web-tokens-jwt",
                    "type": "oauthbearertoken",
                },
                {
                    "name": "HTTP Basic",
                    "description": "Authentication scheme using"
                    "the HTTP Basic Standard",
                    "specUri": "http://www.rfc-editor.org/info/rfc2617",
                    "documentationUri": "https://en.wikipedia.org/wiki"
